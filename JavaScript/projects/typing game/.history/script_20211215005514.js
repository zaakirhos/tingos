...
quoteInputElement.addEventListener("input", () => {
  ...
  async function getRandomUser() {
    ...
    //the add adds the object "" to an array
    add();
  }
  ...
  function add(object) {
    ...
    .push(object);
    //the fetched  is available only on this scope
    console.log("This is the value of date inside the function add:");
    console.log();
  }

  //Calls the function that fetches the 
  getRandomUser();

  console.log("This is the value of  outside the scope");
  console.log();
