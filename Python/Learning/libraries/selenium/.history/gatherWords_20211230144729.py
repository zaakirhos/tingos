...
# for i in range(997):
#     url = f"https://www.dictionaryapi.com/api/v3/references/thesaurus/json/{diff[i]}?key=2e87c6b8-f1de-4822-971a-29dd639ba2ff"
#     response = requests.request("GET", url).json()
#     definition = response["shortdef"][0]
#     new_set.append({"word": diff[i], "definition": definition})
    
# wordC.insert_one({'words': new_set, 'count': len(new_set)})

# url = "https://api.dictionaryapi.dev/api/v2/entries/en/theology"
# response = requests.request("GET", url).json()
# print(response)
url = "https://www.dictionaryapi.com/api/v3/references/thesaurus/json/valor?key=2e87c6b8-f1de-4822-971a-29dd639ba2ff"
response = requests.request("GET", url).json()
print(response[0]["shortDef"])